...
export function TreasureClientShell() {
    ...
    <main className="w-full h-screen bg-black relative" data-route="treasure">
      <div className="absolute top-4 right-4 z-50 flex items-center gap-3">
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-1.5 text-xs sm:text-sm font-medium text-white bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/15 rounded-full transition-all duration-300 shadow-sm hover:scale-105 active:scale-95"
        >
      ...
      <div className="absolute bottom-16 sm:bottom-4 left-4 z-50">
        <div className="relative">
          <button
            ...
            aria-label="AwesomeLM Open Source"
          >
